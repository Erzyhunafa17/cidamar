...
export default function BuatBeritaPage() {
  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      if (file) {
        thumbnail_url = await uploadImage();
      }
      ...
      const res = await fetchWithAuth(`${API_BASE_URL}/api/admin/berita`, {
        method: 'POST',
        headers: {
      ...
      <form onSubmit={handleSubmit} className="bg-white rounded-2xl shadow-sm border border-gray-100 p-6 md:p-8 space-y-6">
        ...
        <div>
          ...
          <input
            ...
            placeholder="Contoh: Warga Gotong Royong Membersihkan Saluran Air"
        ...
        <div>
          ...
          <p className="text-xs text-gray-500 mb-2">Gunakan enter/baris baru untuk memisahkan paragraf.</p>
          <textarea
            required
            rows={10}
